...
class Scoreboard(Turtle):
    def __init__(self):
        ...
        self.color('white')
        # self.hi_score = 0
        with open('snake_score_data.txt') as snakedata:
            self.hi_score = int(snakedata.read())
        self.update_score()
    ...
    def reset_score(self):
        if self.score > self.hi_score:
            ...
            with open('snake_score_data.txt', mode='w') as hi_snake_score:
                hi_snake_score.write(f'{self.hi_score}')
        self.score = 0
        self.update_score()
